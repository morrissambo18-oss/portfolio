...
export default function AdminNav() {
  ...
  return (
    <aside className="w-56 shrink-0 bg-card border-r border-border-subtle flex flex-col">
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 ${
                active
                  ? "text-white bg-electric/20 border border-electric/30"
                  : "text-text-muted hover:text-text-primary hover:bg-surface"
              }`}
            >
              <span className={active ? "text-electric" : ""}>{icon}</span>
              {label}
            </Link>
          );
        })}
      ...
      <div className="p-3 border-t border-border-subtle">
        <a
          href="/"
          className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-text-muted hover:text-text-primary hover:bg-surface transition-colors mb-1"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
